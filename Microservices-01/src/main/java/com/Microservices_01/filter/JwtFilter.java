package com.Microservices_01.filter;
...
import com.Microservices_01.client.AuthServiceFeignClient;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (authHeader != null && authHeader.startsWith("Bearer ")) {
            ...
            UserDto user = authServiceFeignClient.getUserByUsername(username,authHeader);
